...
function Portal(){
  ...
  return <div style={{background:'var(--surface-page)',minHeight:'100vh'}}>
    {SiteNav&&<SiteNav active={tab===1?'calendar':tab===3?'store':'account'} loggedIn links={{home:'#',juniors:'#',camps:'#',adults:'#',jtt:'#',calendar:'#calendar',store:'#store',login:'#profile',book:'#',logoSrc:window.__resources.logoMark}}/>}
